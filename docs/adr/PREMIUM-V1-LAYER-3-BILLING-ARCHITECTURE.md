...
- **Tipos futuros desconocidos**: `notificationType` no documentado → etiqueta `SUBSCRIPTION_UNKNOWN_<n>`, se registra, dispara la reconsulta igual (Google es la autoridad, el mapper es fail-closed), nunca concede desde el RTDN.
