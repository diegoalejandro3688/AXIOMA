// Copia en JS plano (navegador) de ../test-cases.mjs -- mantener sincronizado a mano,
// es solo para el harness de comparación visual del spike.
window.TEST_CASES = [
  { id: 'fraccion', label: 'Fracción', display: true, latex: '\\frac{3x + 1}{2x - 5}' },
  {
    id: 'raiz',
    label: 'Raíz',
    display: true,
