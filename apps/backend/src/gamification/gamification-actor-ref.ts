 ...
 * el secreto (`GAMIFICATION_ACTOR_SECRET`, provisto desde WEB-0D.1C-B2 --
 * ver `gamification-key.ts` para los llamadores reales) se recibe como
 * argumento puro, nunca leído de config aquí, para que ninguna
 * correlación entre dominios sea posible por diseño (secretos distintos
 * -> refs distintos aun para la misma cuenta).
 */
